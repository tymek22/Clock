...
#define Launcher_CMD_SYNC_BOOTLOADER_AVAIL  (1u)
#define Launcher_CMD_SEND_DATA_AVAIL        (1u)
#define Launcher_CMD_VERIFY_APP_CHKSUM_AVAIL (1u)
#define Launcher_CMD_GET_METADATA           (0u)
#define Launcher_CMD_VERIFY_FLS_ROW_AVAIL   (1u)
#define Launcher_GOLDEN_IMAGE_AVAIL         (0u)
#define Launcher_SECURITY_KEY_AVAIL         (0u)
#define Launcher_AUTO_SWITCHING_AVAIL       (1u)
    ...
    #define Launcher_COPIER_AVAIL           (1u)
...
#define Launcher_META_CHECKSUM_ADDR(x)          (Launcher_META_BASE(x) + \
    ...
    #if(!CY_PSOC4)
        #define Launcher_MD_ROW                 ((CY_FLASH_NUMBER_ROWS / Launcher_NUM_OF_FLASH_ARRAYS) \
                                                        - 1u)
    #else
...
#else
    #if(!CY_PSOC4)
        #define Launcher_MD_ROW(x)              ((CY_FLASH_NUMBER_ROWS / Launcher_NUM_OF_FLASH_ARRAYS) \
                                                        - 1u - ( uint32 )(x))
    #else
