// ======================================================================
// BLE_OTA_UpgradableStackExample_Launcher01.v generated from TopDesign.cysch
// 07/31/2019 at 22:50
...
module SW_Tx_UART_v1_50_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("179054c1-e42a-4cb1-a570-3138971faf36/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__L_LED_net;
	wire [0:0] tmpFB_0__L_LED_net;
	wire [0:0] tmpIO_0__L_LED_net;
	wire [0:0] tmpINTERRUPT_0__L_LED_net;
	electrical [0:0] tmpSIOVREF__L_LED_net;
	...
	cy_psoc3_pins_v1_10
		...
		L_LED
		 (.oe(tmpOE__L_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__L_LED_net[0:0]}),
		  .io({tmpIO_0__L_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__L_LED_net),
		  .interrupt({tmpINTERRUPT_0__L_LED_net[0:0]}),
		  .annotation({Net_202}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__L_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
