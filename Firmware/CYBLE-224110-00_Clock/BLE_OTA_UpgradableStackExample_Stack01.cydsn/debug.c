...
/* returns number of decimal digits in 'value' */
uint32 decLength(uint32 value)
{
    uint32 decValue = 10;
    uint32 result = 10;
    uint32 i;
...
/*
* prints decimal value with zero padding to the length,
* e.g value = 123, length = 5, result = "00123"
*/
void DBG_PRINT_DEC2(uint32 value, uint32 length)
{
    uint32 i = decLength(value);
