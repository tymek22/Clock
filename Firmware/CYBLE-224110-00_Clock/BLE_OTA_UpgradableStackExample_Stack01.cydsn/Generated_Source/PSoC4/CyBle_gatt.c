    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x012Cu] = {
    /* Device Name */
    (uint8)'O', (uint8)'T', (uint8)'A', (uint8)' ', (uint8)'B', (uint8)'o', (uint8)'o', (uint8)'t', (uint8)'l',
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Bootloader UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Command UUID */
    { 0x0110u, (void *)&cyBle_attValues[28] }, /* Command */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x0Fu] = {
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00180001u /* wr,ntf */, 0x000Fu, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0x0001u /* Command                             */, 0x09180300u /* wr,ntf */, 0x000Fu, {{0x0110u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x010A0301u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
};
