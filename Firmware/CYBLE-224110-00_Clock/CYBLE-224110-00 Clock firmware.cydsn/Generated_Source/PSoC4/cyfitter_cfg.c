...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_BLE_BLERD_BB_XO_CAPTRIM), 0x00005555u);
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL2, 0x0001F300u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xEE900000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x00A40000u);
		...
		CY_SET_REG32((void *)(CYREG_CPUSS_INT_SEL), 0x0000000Au);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DB0D80u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00080000u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_INTR_CFG), 0x00002000u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x00000032u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00064000u);
