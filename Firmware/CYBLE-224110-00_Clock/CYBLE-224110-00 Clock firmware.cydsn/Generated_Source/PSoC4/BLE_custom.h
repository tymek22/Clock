...
#define CYBLE_SET_TIME_SERVICE_INDEX   (0x00u) /* Index of Set Time service in the cyBle_customs array */
#define CYBLE_SET_TIME_TIME_CHAR_INDEX   (0x00u) /* Index of Time characteristic */
#define CYBLE_SET_TIME_TIME_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CYBLE_SET_COLOR_SERVICE_INDEX   (0x01u) /* Index of Set Color service in the cyBle_customs array */
#define CYBLE_SET_COLOR_COLOR_CHAR_INDEX   (0x00u) /* Index of Color characteristic */
#define CYBLE_SET_COLOR_COLOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_SET_TIME_SERVICE_HANDLE   (0x0010u) /* Handle of Set Time service */
#define CYBLE_SET_TIME_TIME_DECL_HANDLE   (0x0011u) /* Handle of Time characteristic declaration */
#define CYBLE_SET_TIME_TIME_CHAR_HANDLE   (0x0012u) /* Handle of Time characteristic */
#define CYBLE_SET_TIME_TIME_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */

#define CYBLE_SET_COLOR_SERVICE_HANDLE   (0x0014u) /* Handle of Set Color service */
#define CYBLE_SET_COLOR_COLOR_DECL_HANDLE   (0x0015u) /* Handle of Color characteristic declaration */
#define CYBLE_SET_COLOR_COLOR_CHAR_HANDLE   (0x0016u) /* Handle of Color characteristic */
#define CYBLE_SET_COLOR_COLOR_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0017u) /* Handle of Characteristic User Description descriptor */
