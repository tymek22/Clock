...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    /* Set Time service */
    {
        0x0010u, /* Handle of the Set Time service */ 
        {

            /* Time characteristic */
            {
                0x0012u, /* Handle of the Time characteristic */ 
    ...
    /* Set Color service */
    {
        0x0014u, /* Handle of the Set Color service */ 
        {

            /* Color characteristic */
            {
                0x0016u, /* Handle of the Color characteristic */ 
